...
//   }
  ...
  const [
    ...
    import('$lib/realtime/graphql/requestHandler'),
    import('$lib/stores/jobUpdateStore'),
    import('$lib/stores/appSyncClientStore'),
    import('$lib/realtime/graphql/subscriptions/Job')
  ]);
 ...
 * import { createJobSubmissionClientSync } from '$lib/dashboard/lib/JobManager';
 * 
