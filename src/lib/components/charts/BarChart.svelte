  ...
  <Card class="max-w-full">
    ...
    <div class="grid grid-cols-2">
      <dl class="flex items-center">
        <dt class="text-gray-500 dark:text-gray-400 text-sm font-normal me-1">Current Annual Rent:</dt>
        <dd class="text-gray-900 text-sm dark:text-white font-semibold">$149,919</dd>
      </dl>
      
      <dl class="flex items-center justify-end">
        <dt class="text-gray-500 dark:text-gray-400 text-sm font-normal me-1">Option #3:</dt>
        <dd class="text-gray-900 text-sm dark:text-white font-semibold">$219,496</dd>
      </dl>
    </div>
    <Chart {options} />
